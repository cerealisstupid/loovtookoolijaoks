...
async function laadNimekiri() {
    try {
        const vastus = await fetch("/back/api/nimekiri.php");
...
document.getElementById("reg").onclick = async () => {
    try {
        ...
        const vastus = await fetch("/back/api/lisa.php", {
            method: "POST",
...
document.getElementById("unreg").onclick = async () => {
    try {
        ...
        const vastus = await fetch("/back/api/eemalda.php", {
            method: "POST",
            headers: { "Content-Type": "application/x-www-form-urlencoded" },
            body: "name=" + encodeURIComponent(kontrollitudNimi)
        });
...
async function laadSaadavalAjad() {
    try {
        const vastus = await fetch('/back/api/koik_ajad.php');
        const andmed = await vastus.json();
...
document.getElementById("regSlot").onclick = async () => {
    try {
        ...
        const vastus = await fetch("/back/api/lisa_konsultatsioon.php", {
            method: "POST",
...
document.getElementById("unregSlot").onclick = async () => {
    try {
        ...
        const vastus = await fetch("/back/api/eemalda_konsultatsioon.php", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({
                studentName: kontrollitudNimi
...
async function laadKonsultatsioonid() {
    try {
        const vastus = await fetch("/back/api/konsultatsioonide_nimekiri.php");
